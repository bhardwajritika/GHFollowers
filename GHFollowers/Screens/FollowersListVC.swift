    ...
    func getFollowers (username: String, page: Int) {
        ...
        NetworkManager.shared.getFollowers(for: username, page: page) { [weak self]
            ...
            case .success(let followers):
                ...
                // check if the followers array is empty
...
extension FollowersListVC: UICollectionViewDelegate {
    ...
    func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
        ...
        // pagination in the follower list
        let offsetY = scrollView.contentOffset.y
        let contentHeight = scrollView.contentSize.height
        let height = scrollView.frame.size.height
        
        // reload the next page after the user scrolls down
...
extension FollowersListVC: FollowersListVCDelegate {
    func didRequestFollowers(for username: String) {
        ...
        // reset the screen
        self.username = username // reset username
        title = username         // reset title
